...
const STEPS = [
  {
    ...
    body: 'Everything on this console is a function of this slider. It scrubs one '
      + 'complete 94.9-minute orbit in 90 seconds — and because the loop is exactly '
      + 'one orbit, it ends where it began. The curve behind it is the real battery '
      + 'state of charge; the shaded bands are the operating modes.',
    slider: 0.08,
  },
  {
    target: '#power-panel',
  ...
  },
  {
    ...
    body: 'Watch this number. Coasting, the console runs at about 124× real time. As '
      ...
      + 'and it is reported in every telemetry frame rather than hidden.',
    slider: 0.50,
  },
  {
    target: '#globe-panel',
  ...
  },
  {
    ...
    body: 'Every line in this log is a value shown elsewhere on the console, tagged '
      + 'with its CCSDS application ID. Each panel also carries a SOURCE line naming '
      + 'the model behind it. Tour complete — the slider is yours.',
    slider: 0.84,
  },
];
